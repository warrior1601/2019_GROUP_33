...
int main()
{
    std::cout << "------------------------------Model.hpp Test Code------------------------------" << endl;
    ...
    std::cout << "\n\n---Model properties of Model_One.txt---" << std::endl;
    std::cout << "\nVolume of model = " << ModelOne.Get_Volume() << std::endl;
    std::cout << "\nWeight of model = " << ModelOne.Get_Weight() << std::endl;
    std::cout << "\nCentre of gravity of model = " << ModelOne.Get_Centre_Of_Gravity() << std::endl;
    std::cout << "Geometric centre of model = " << ModelOne.Get_Geometric_Centre() << std::endl;
    std::cout << "Overall dimensions of model = " << ModelOne.Get_Overall_Dimensions() << std::endl;
    ...
    std::cout << "Centre of gravity =\t" << ModelTwo.Get_Centre_Of_Gravity() << std::endl;
    std::cout << "Geometric centre =\t" << ModelTwo.Get_Geometric_Centre() << std::endl;
    std::cout << "Overall dimensions =\t" << ModelTwo.Get_Overall_Dimensions() << std::endl;
	...
	std::cout << "Note that Model_Two.txt and the Save_File_Of_Model_Two_UnRotated.txt are the same model and thus contain the same information" << endl;

    Model Example1;
    Example1.Load_Model("ExampleModel1.mod");
    std::cout << "\n\n\n---ExampleModel1.mod Model---\n" << Example1 << std::endl;
    std::cout << "Centre of gravity =\t" << Example1.Get_Centre_Of_Gravity() << std::endl;
    std::cout << "Geometric centre =\t" << Example1.Get_Geometric_Centre() << std::endl;
    std::cout << "Overall dimensions =\t" << Example1.Get_Overall_Dimensions() << std::endl;


    Model Example2;
    Example2.Load_Model("ExampleModel2.mod");
    std::cout << "\n\n\n---ExampleModel2.mod Model---\n" << Example2 << std::endl;
    std::cout << "Centre of gravity =\t" << Example2.Get_Centre_Of_Gravity() << std::endl;
    std::cout << "Geometric centre =\t" << Example2.Get_Geometric_Centre() << std::endl;
    std::cout << "Overall dimensions =\t" << Example2.Get_Overall_Dimensions() << std::endl;


    Model Example3;
    Example3.Load_Model("ExampleModel3.mod");
    std::cout << "\n\n\n---ExampleModel3.mod Model---\n" << Example3 << std::endl;
    std::cout << "Centre of gravity =\t" << Example3.Get_Centre_Of_Gravity() << std::endl;
    std::cout << "Geometric centre =\t" << Example3.Get_Geometric_Centre() << std::endl;
    std::cout << "Overall dimensions =\t" << Example3.Get_Overall_Dimensions() << std::endl;

    Model Test;
    Test.Load_Model("Model_Three.txt");
    cout<<"here"<<endl;
    std::cout << "\n\n\n---ExampleModel3.mod Model---\n" << Test << endl;
    std::cout << "Centre of gravity =\t" << Test.Get_Centre_Of_Gravity() << endl;
    std::cout << "Geometric centre =\t" << Test.Get_Geometric_Centre() << endl;
    std::cout << "Overall dimensions =\t" << Test.Get_Overall_Dimensions() << endl;
